...
namespace ListandoPessoas2.Controller
{
    class PessoaController
    {
        ...
        /// <summary>
        /// O metodo construtor ajuda iniciar nossa classe para utilizrmos de 
        /// maneira corret as informacoes interna com isso podemeos iniciar nossa 
        ...
        /// nao damos acesso para alterar fora da classe a lista 
        /// apenas visualizacao
        /// </summary>
        public List<Pessoa> ListaDePessoasPublica
        {
            //No get podemos retornar propriedades privada
            //e calcuo de metodos quando necessario 
            get { return ListaDePessoas; }
        }

        /// <summary>
        /// Metodo que retorna lista de pessoas ordenada de forma Asc
        /// pelo nome de cada uma 
        /// </summary>
        /// <returns>Retornamos o valor ja ordenado de nossa lista </returns>
        public List<Pessoa> GetPessoasOrdenadaAsc()
        {
            //Aqui temos nossa lista 
            return ListaDePessoas
                //Aqui ordenamos ela , IEnumerable é novo tipo dela durante a conversao
                .OrderBy(x => x.Nome)
        ...
        /// </summary>
        /// <param name="valor">Valor informado para ofiltro</param>
        /// caso nao informo o parametro o valor padrao se torna 500
        /// <returns>Retorna a lista com o valor definido e ordenado</returns>
        public List<Pessoa> GetPessoasComMaisPilasNaCarteira(
            //Em caso de nao informamos o valor ele dfica 500 se nao ele passa 
            ...
            double valor = 500)
        {
            return ListaDePessoas
                ...
                //ordenamos as informacoes
                .OrderBy(x => x.Carteira)
                //Convertemos para uma lista do tipo pessoa
                .ToList<Pessoa>();
        }
        /// <summary>
        /// Metodo que reotrna a lista de pessoas com idade maior que idade
        /// informada , caso nao informa do um valor o padrao é 18
        /// informada
        /// </summary>
