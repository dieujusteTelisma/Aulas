...
//criamos este var data porque nao podemos mais acessar os cep via o servidor porque o nosso IP esta fasendo muita busca em segundo
var data = [
    {
        "cep": "91710-480",
    ...
    $('#Button1').click(function () {
        ...
        $.each(data, function (key, value) {
            ...
            $('#divContent').append(
                ...
                "<option>" + value.bairro + "</optio>" +
                "<option>" + value.cep + "</optio>" +
                "<option>" + value.logradouro + "</optio>" +
                "<option>" + value.complemento + "</optio>" +
                "<option>" + value.localidade + "</optio>" +
                "<option>" + value.uf + "</optio>" +
                "<option>" + value.ibge + "</optio>" +
                "<option>" + value.gia + "</optio>" +
                "</select>"
